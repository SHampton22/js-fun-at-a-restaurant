...
inStock *= 2;
//console.log(inStock); //should print 20
...
inStock --;
//console.log(inStock); // should print 19
...
//console.log(shouldOrderMore); // should print 'true' becuase the variable inStock is 19.
//------------------------- Conditionals -------------------------//
...
// should return "I'm going to eat some Ice cream" since inStock = 19.
...
if (isFavorite === true) {
    console.log(`My favorit food is ${food}!`);
} else {
...
var vegetables = ['carrots', 'peas', 'cucumbers', 'broccoli', 'green beans'];
...
// different fruits.
var fruits = ['grapes', 'blueberries', 'strawberries', 'pineapples', 'watermelon', 'apples', 'oranges'];
